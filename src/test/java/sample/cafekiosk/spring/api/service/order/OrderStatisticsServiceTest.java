...
class OrderStatisticsServiceTest extends IntegrationTestSupport {
	...
	void sendOrderStatisticsMail() {
		...
		Order order1 = createPaymentCompleteOrder(products, LocalDateTime.of(2023, 3, 4, 23, 59, 50));
		Order order2 = createPaymentCompleteOrder(products,now);
		Order order3 = createPaymentCompleteOrder(products, LocalDateTime.of(2023, 3, 5, 23, 59, 50));
